...
/** GET /[username] => { user }
 *
 * Returns { user: username, firstName, lastName, isAdmin, applications }
 ...
 * calls User model to create association between username and jobId on applications table in DB
 * Authorization required: login or admin
 **/
